...
public class StringTransformerGroupTest{
    ...
    public void transformerGroup() {
        ...
        List<StringTranformer> transformers = new ArrayList<>();
        transformers.add(si);
        transformers.add(cc);
